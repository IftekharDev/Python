...
'''
This function doesn't care about the type of the object. It only cares that the object has 'quack' and 'fly' methods.
'''
...
'''
abstraction isn't for changing the output; it's for building a strong, error-resistant 
foundation for your program. It's a tool for managing complexity and ensuring that all the different 
parts of your system work together correctly.
'''